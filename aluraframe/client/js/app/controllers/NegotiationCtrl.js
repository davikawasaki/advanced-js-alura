...
System.register(['../models/NegotiationList', '../models/Message', '../models/Negotiation', '../views/NegotiationView', '../views/MessageView', '../services/NegotiationService', '../helpers/DateHelper', '../helpers/Bind', '../services/ConnectionFactory', '../dao/NegotiationDAO'], function (_export, _context) {
    "use strict";

    var NegotiationList, Message, Negotiation, NegotiationView, MessageView, NegotiationService, DateHelper, Bind, ConnectionFactory, NegotiationDAO, _createClass, NegotiationCtrl, negotiationCtrl;
    ...
    return {
        ...
        }, function (_viewsNegotiationView) {
            NegotiationView = _viewsNegotiationView.NegotiationView;
        ...
        execute: function () {
            ...
            negotiationCtrl = new NegotiationCtrl();
        }
    };
});
